    ...
    <article className="animate-slide-up">
      ...
      <div className="grid grid-cols-1 gap-12 mb-12">
        <section className="relative">
          <div className="flex items-center gap-4 relative z-10">
            ...
            <h3 className="text-2xl font-bold text-white font-mono uppercase">{t('resume.education')}</h3>
          </div>
          ...
          <div className="relative pt-1 space-y-12 -mt-2">
            ...
            {EDUCATION.map((edu) => (
              <div key={edu.id} className="relative pl-[60px] group">
                ...
                <h4 className="text-white font-bold text-xl mb-1">{edu.degree[language]}</h4>
                <span className="text-[#ccff00] text-xs font-bold font-mono mb-2 inline-block border border-[#ccff00]/30 px-2 py-1 bg-[#ccff00]/5">
                  {edu.period[language]}
                </span>
        ...
        <section className="relative">
          <div className="flex items-center gap-4 relative z-10">
            ...
            <h3 className="text-2xl font-bold text-white font-mono uppercase">{t('resume.experience')}</h3>
          </div>
          ...
          <div className="relative pt-1 space-y-12 -mt-2">
            ...
            {EXPERIENCE.map((job) => (
              <div key={job.id} className="relative pl-[60px] group">
                ...
                <h4 className="text-white font-bold text-xl mb-1">{job.role[language]}</h4>
                <span className="text-[#ccff00] text-xs font-bold font-mono mb-2 inline-block border border-[#ccff00]/30 px-2 py-1 bg-[#ccff00]/5">
                  {job.period[language]}
                </span>
      ...
      <section className="bg-[#0a0a0a] p-8 rounded-sm border border-[#333] relative overflow-hidden">
        ...
        <h3 className="text-xl font-bold text-white mb-6 font-mono uppercase flex items-center gap-2">
           <span className="text-[#ccff00]">{'>'}</span> {t('resume.skills')}
        </h3>
